...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-full -z-10 bg-[radial-gradient(circle_at_30%_30%,#f0fdf4_0%,transparent_50%)]"></div>
            <Navbar />
            <div className="flex-1 flex items-center justify-center p-8 animate-fade-in">
                <div className="glass p-12 rounded-[32px] shadow-2xl w-full max-w-lg border border-white/50 relative">
                    ...
                    <h2 className="text-4xl font-black text-gray-900 mb-2 tracking-tight text-center">Renew<span className="text-emerald-600 font-black">X</span></h2>
                    <p className="text-gray-500 mb-10 text-center font-medium">Digital Green Energy Exchange</p>
